...
public class Client implements IClient {
    ...
    public String categorizeTitleAndAbstract(String workflow, String title, String text) throws HttpException {
        ...
        String result = categorize(combined);
        return result;
    }

    @Override
    public void categorizeTitleAndAbstract(String workflow, String title, String text, DefaultHandler xmlHandler) throws HttpException,
	...
	private Response executePost(String path, String data) throws HttpException {
    	...
    	if (response.getStatus()!=Response.Status.OK.getStatusCode()) {
    		throw new HttpException("End point returned status code " + response.getStatus());
    	}
		return response;
	}
